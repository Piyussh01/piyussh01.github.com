        ...
        return (
            <>
                <div id="about" tabIndex="0" onFocus={this.changeScreen} className={(this.state.active_screen === "about" ? " bg-ub-orange bg-opacity-100 hover:bg-opacity-95" : " hover:bg-gray-50 hover:bg-opacity-5 ") + " w-28 md:w-full md:rounded-none rounded-sm cursor-default outline-none py-1.5 focus:outline-none duration-100 my-0.5 flex justify-start items-center pl-2 md:pl-2.5"}>
                    <img className=" w-3 md:w-4" alt="about piyussh" src="./themes/Yaru/status/about.svg" />
    ...
    return (
        <>
            ...
            <div className=" mt-4 md:mt-8 text-lg md:text-2xl text-center px-1">
                <div>my name is <span className="font-bold">Piyussh Singhal</span> ,</div>
                <div className="font-normal ml-1">I'm a <span className="text-pink-600 font-bold">Backend + Electrical Hobbyist + LMVM</span></div>
            </div>
            ...
            <ul className=" mt-4 leading-tight tracking-tight text-sm md:text-base w-5/6 md:w-3/4 emoji-list">
                <li className=" list-pc">I'm a <span className=" font-medium">Senior Undergrad Student</span> currently pursuing Computer Science. I'm looking for full-time engineering roles! ( Hit me up <a className='text-underline' href='mailto:psing107@asu.edu'><u>@psing107@asu.edu</u></a> :) )</li>
                <li className=" mt-3 list-building"> All about solving sustainability problems with software, AI, and automation</li>
                <li className=" mt-3 list-time"> Have a look at my Youtube and watch me brag about this electric bike in a month- <a href="https://www.youtube.com/@piyussh01" target="_blank" rel="noreferrer"> https://www.youtube.com/@piyussh01</a></li>
                <li className=" mt-3 list-star"> "Focus in the parts unseen" </li>
            </ul>
        </>
    )
}
...
function Projects() {
    const project_list = [
        {
            name: "Biocomputing Group Research Website",
            date: "Fall 2023",
            link: "github.com/Lee-CBG/Lee-CBG.github.io",
            description: [
                "Made a static research website for the Biocomputing Group at ASU hosted on Github Pages",
            ],
            domains: ["SCSS", "HTML", "CSS", "Javascript"]
        },
        {
            name: "Application Flyer for Biodesign Institute Program",
            date: "Fall 2023",
            link: "https://github.com/ASU-BD-BSS/ASU-BD-BSS.github.io",
            description: [
                "Application website for students to learn about this program and apply",
            ],
            domains: ["SCSS", "HTML", "CSS", "Ruby"]
        }
    ];
...
function Resume() {
    return (
        <iframe className="h-full w-full" src="./files/Singhal_Resume.pdf" title="My Resume" frameBorder="0"></iframe>
    )
}